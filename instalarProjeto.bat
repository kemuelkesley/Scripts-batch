...
if %opcao% equ 1 (
    ...
    echo ================================================================
    rem
    start cmd /k "cd /d "!folderPath!" & cmd /k call "!folderPath!\env\Scripts\activate" && echo Ambiente virtual ativado com sucesso. || echo Falha ao ativar o ambiente virtual."    
    rem 
    timeout /t 5
) else if %opcao% equ 4 (
    echo ===============================================================
    ...
    echo ===============================================================
    rem 
    start cmd /k "cd /d "!folderPath!" & python manage.py migrate"
) else if %opcao% equ 6 (
    echo ===============================================================
